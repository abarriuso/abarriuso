...
|----------|-------------|
| [🔬 melanoma-detection-vgg16](https://github.com/abarriuso/melanoma-detection-vgg16) | Clasificación binaria de lesiones cutáneas con VGG16 + Grad-CAM. Inferencia 100% client-side con TensorFlow.js. |
| [☀️ Analemas](https://github.com/abarriuso/Analemas) | Simulación interactiva del analema solar y planetario en Canvas 2D, sin dependencias. |
